...
from diff_representation.asdl.syntax_tree import AbstractSyntaxNode, AbstractSyntaxTree, SyntaxToken
from .actions import *
            ...
            for field in target_ast_node.fields:
                if self.grammar.is_composite_type(field.type):
                    ...
                    if field.cardinality == 'multiple' or field.cardinality == 'optional' and not field_actions:
                        ...
                        field_actions.append(GenTokenAction(SyntaxToken(field.type, TransitionSystem.END_OF_SYNTAX_TOKEN_LIST_SYMBOL)))
