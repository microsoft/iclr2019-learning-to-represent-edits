...
from diff_representation.utils.utils import *
from diff_representation.utils.relevance import *
...
def decode_change_vec(args):
    ...
    dataset = DataSet.load_from_jsonl(type='tree2tree_subtree_copy' if is_graph_change_encoder else 'sequential',
                                      transition_system=TransitionSystem(model.grammar) if '2tree' in args['--mode'] else None,
                                      max_workers=1,
                                      parallel=False,
