...
from diff_representation.model.gnn import AdjacencyList, GatedGraphNeuralNetwork
from diff_representation.model.utils import get_method_args_dict
...
class SyntaxTreeEncoder(nn.Module):
    def __init__(self, hidden_size, syntax_tree_embedder, connections, layer_timesteps, residual_connections, dropout, vocab, grammar, **kwargs):
